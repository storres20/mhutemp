/* 21/03/2025 - WebSocket auto-reconnect, ping keep-alive, OLED restore */
...
void setup() {
  ...
  //webSocket.onPong([](uint8_t * payload, size_t length) {
...
void loop() {
  ...
  // Force reconnect if disconnected for over 10s
  ...
  // Reinitialize OLED if it was off
